...
namespace TechnitiumLibrary.Net.Dns
{
    ...
    public class DnsClient
    {
        ...
        public static string[] ParseResponseDIDID(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> dididRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDID:
                                    dididRecords.Add(((DnsDIDIDRecord)record.RDATA).DID);
                                    break;
        ...
        public static string[] ParseResponseDIDCTX(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> didctxRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDCTX:
                                    didctxRecords.Add(((DnsDIDCTXRecord)record.RDATA).Data);
                                    break;
        ...
        public static string[] ParseResponseDIDSVC(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> didsvcRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDSVC:
                                    didsvcRecords.Add(((DnsDIDSVCRecord)record.RDATA).ServiceEndpointUrl);
                                    break;
        ...
        public static string[] ParseResponseDIDPUBK(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> didpubkRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDPUBK:
                                    didpubkRecords.Add(((DnsDIDPUBKRecord)record.RDATA).SubjectPublicKey);
                                    break;
        ...
        public static string[] ParseResponseDIDATHN(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> didathnRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDATHN:
                                    didathnRecords.Add(((DnsDIDATHNRecord)record.RDATA).AuthenticationPublicKey);
                                    break;
        ...
        public static string[] ParseResponseDIDTXT(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> didtxtRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDTXT:
                                    didtxtRecords.Add(((DnsDIDTXTRecord)record.RDATA).TextData);
                                    break;
        ...
        public static string[] ParseResponseDIDSUBSIG(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDSUBSIG:
                                    didtxtRecords.Add(((DnsDIDSUBSIGRecord)record.RDATA).SigData);
                                    break;
        ...
        public static string[] ParseResponseDIDEXTDAT(DnsDatagram response)
        {
            string domain = response.Question[0].Name;
            ...
            switch (response.Header.RCODE)
            {
                case DnsResponseCode.NoError:
                    ...
                    List<string> diddataRecords = new List<string>();
                        ...
                        if (record.Name.Equals(domain, StringComparison.OrdinalIgnoreCase))
                        {
                            switch (record.Type)
                            {
                                case DnsResourceRecordType.DIDEXTDAT:
                                    diddataRecords.Add(((DnsDIDEXTDATRecord)record.RDATA).Tag);
                                    break;
        ...
        {
            if (domain.StartsWith("did:") && (queryType.ToString().StartsWith("DID") || queryType.ToString() == "ANY")) // mwh
            {
        ...
        public string[] ResolveDIDID(string domain) // mwh
        {
            return ParseResponseDIDID(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDID, DnsClass.IN)));
        }
        public string[] ResolveDIDCTX(string domain) // mwh
        {
            return ParseResponseDIDCTX(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDCTX, DnsClass.IN)));
        }
        public string[] ResolveDIDSVC(string domain) // mwh
        {
            return ParseResponseDIDSVC(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDSVC, DnsClass.IN)));
        }
        public string[] ResolveDIDPUBK(string domain) // mwh
        {
            return ParseResponseDIDPUBK(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDPUBK, DnsClass.IN)));
        }
        public string[] ResolveDIDATHN(string domain) // mwh
        {
            return ParseResponseDIDATHN(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDATHN, DnsClass.IN)));
        }
        public string[] ResolveDIDTXT(string domain) // mwh
        {
            return ParseResponseDIDTXT(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDTXT, DnsClass.IN)));
        }
        public string[] ResolveDIDSUBSIG(string domain) // mwh
        {
            return ParseResponseDIDSUBSIG(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDSUBSIG, DnsClass.IN)));
        }
        public string[] ResolveDIDEXTDAT(string domain) // mwh
        {
            return ParseResponseDIDEXTDAT(Resolve(new DnsQuestionRecord(domain, DnsResourceRecordType.DIDEXTDAT, DnsClass.IN)));
        }
